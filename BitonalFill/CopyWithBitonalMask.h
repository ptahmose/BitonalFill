...
/// 
/// The ROI from the source is copied to a destination bitmap of width = roi_width and height = roi_height.
/// This function uses AVX-instructions - support for AVX must be checked before calling into this function.
///
/// \param          width                   The width of the source bitmap (and the source mask) in pixels.
/// \param          height                  The height of the source bitmap (and the source mask) in pixels.
/// \param          source_bitonal          Pointer to the bitonal mask.
...
/// 
/// The ROI from the source is copied to a destination bitmap of width = roi_width and height = roi_height.
/// This function uses ARM-NEON-instructions.
///
/// \param          width                   The width of the source bitmap (and the source mask) in pixels.
/// \param          height                  The height of the source bitmap (and the source mask) in pixels.
/// \param          source_bitonal          Pointer to the bitonal mask.
...
inline int CopyWithBitonalMask_Gray8_NEON(
    std::uint32_t width,
    std::uint32_t height,
    const std::uint8_t* source_bitonal,
    std::uint32_t source_bitonal_stride,
    ...
    std::uint32_t destination_stride)
{
    return CopyWithBitonalMask_Roi_Gray8_NEON(
        width, height,
        source_bitonal, source_bitonal_stride,
        source, source_stride,
        0, 0, width, height,
...
inline int CopyWithBitonalMask_Gray16_NEON(
    std::uint32_t width,
    std::uint32_t height,
    const std::uint8_t* source_bitonal,
    std::uint32_t source_bitonal_stride,
    ...
    std::uint32_t destination_stride)
{
    return CopyWithBitonalMask_Roi_Gray16_NEON(
        width, height,
        source_bitonal, source_bitonal_stride,
        source, source_stride,
        0, 0, width, height,
