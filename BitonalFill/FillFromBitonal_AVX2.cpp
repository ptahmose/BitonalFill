    ...
    std::uint16_t valueForOnesBlue)
{
    ...
    for (uint32_t y = 0; y < height; ++y)
    {
        ...
        for (uint32_t x16 = 0; x16 < widthOver16; ++x16)
        {
            ...
            _mm_maskmoveu_si128(/*value2_2*/value1_1, _mm_unpackhi_epi8(maskForStore2, maskForStore2), reinterpret_cast<char*>(ptrDst + 24));
            _mm_maskmoveu_si128(/*value3_1*/value1_2, _mm_unpacklo_epi8(maskForStore3, maskForStore3), reinterpret_cast<char*>(ptrDst + 32));
            _mm_maskmoveu_si128(/*value3_2*/value2_1, _mm_unpackhi_epi8(maskForStore3, maskForStore3), reinterpret_cast<char*>(ptrDst + 40));
