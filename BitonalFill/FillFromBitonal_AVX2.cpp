...
#define FILLFROMBITONALFROMONEORZERO_GRAY8_AVX(_op_)                        \
    ...
    std::uint8_t valueForOnes)
{
    ...
    //FILLFROMBITONALFROMONEORZERO_GRAY8_AVX(_mm_andnot_si128)
    /*
    const __m128i value = _mm_set1_epi8(static_cast<char>(valueForOnes));
    const __m128i zero = _mm_setzero_si128();
...
{
//    FILLFROMBITONALFROMONEORZERO_GRAY8_AVX(_mm_and_si128)
    And and;
